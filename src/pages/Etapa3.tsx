...
const FAQ = [
  { q: 'Preciso saber montar fichas ou documentos?', a: 'NÃ£o. EstÃ¡ tudo pronto â€” vocÃª sÃ³ preenche durante o atendimento.' },
  { q: 'Esse material realmente me protege como profissional?', a: 'Sim. Ele organiza informaÃ§Ãµes e cria um registro formal do atendimento.' },
  { q: 'Posso usar mesmo sendo iniciante?', a: 'Sim. Inclusive, Ã© o ideal para comeÃ§ar jÃ¡ com postura profissional.' },
  { q: 'Em quanto tempo posso aplicar?', a: 'No mesmo dia. VocÃª jÃ¡ pode usar no prÃ³ximo atendimento.' },
  { q: 'Isso vai deixar meu atendimento mais profissional mesmo?', a: 'Sim. Clientes percebem organizaÃ§Ã£o e confianÃ§a imediatamente.' },
  { q: 'E se eu nÃ£o me adaptar ao material?', a: 'VocÃª pode simplesmente nÃ£o usar. O investimento Ã© baixo e o risco mÃ­nimo.' },
];

const KIT = [
  'ðŸ“˜ Kit Completo de Fichas + Anamnese + Termos Profissionais',
  'ðŸŽ Modelo de Termo de Consentimento Profissional',
  'ðŸŽ Checklist de Atendimento Seguro',
  'ðŸŽ Guia de OrganizaÃ§Ã£o para Micropigmentadoras',
];
      ...
      <div className="max-w-2xl w-full mx-auto">
        ...
        <div className="text-center mb-8">
          <span className="inline-block bg-[#c4962a]/20 border border-[#c4962a]/40 text-[#c4962a] text-xs font-bold px-4 py-1 rounded-full mb-4 tracking-widest">
            ðŸ’° ETAPA 3 DE 3 â€” OFERTA
          </span>
          <h1 className="text-2xl sm:text-3xl font-black leading-tight mb-4">
            Atenda com <span className="text-[#c4962a]">seguranÃ§a, respaldo e profissionalismo</span> usando fichas e documentos prontos â€” e evite erros que podem custar sua reputaÃ§Ã£o.
          </h1>
        </div>

        <div className="space-y-2 mb-8">
          {FAQ.map((item, i) => (
            <FAQItem key={i} q={`${i + 1}ï¸âƒ£ ${item.q}`} a={item.a} />
          ))}
        </div>

        <div className="bg-[#1a1208] border-2 border-[#c4962a]/50 rounded-2xl p-6 mb-8">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[#c4962a] text-xl">ðŸ”’</span>
          ...
          <p className="text-[#d0c8b8] text-sm mb-4 leading-relaxed">
            Sei que esse kit jÃ¡ vai te ajudar muitoâ€¦ Mas se vocÃª quer se posicionar como profissional de verdade, tem algo a mais.
          </p>
          ...
          <p className="text-[#d0c8b8] text-sm">
            Funciona para qualquer profissional que quer parar de improvisar e comeÃ§ar a ser levada a sÃ©rio.
          </p>
        </div>

        <div className="bg-[#1a1208] border border-[#c4962a]/30 rounded-2xl p-8 text-center mb-6">
          <p className="text-[#d0c8b8] text-sm mb-1">Acesso imediato â€” Ticket Ãšnico</p>
          <p className="text-6xl font-black text-white mb-1">
            <span className="text-2xl text-[#d0c8b8]">R$</span>17,00
          </p>
          <p className="text-[#c4962a] text-xs mb-6 font-semibold">âš¡ Oferta exclusiva disponÃ­vel apenas nesta pÃ¡gina</p>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              ðŸ”¥ Quero o acesso completo por R$17,00
            </a>
            <a
              href={PAYMENT_LINK}
              target="_blank"
            ...
            >
              NÃ£o, obrigado. Quero apenas o bÃ¡sico.
            </a>
          </div>
